package cn.mask.mask.label.dubbo.common.aop;

import cn.mask.mask.label.dubbo.common.dbutils.DBContextHolder;
...
public class DataSourceAop {
    ...
    @Pointcut("!@annotation(cn.mask.mask.label.dubbo.common.annotation.Master) " +
